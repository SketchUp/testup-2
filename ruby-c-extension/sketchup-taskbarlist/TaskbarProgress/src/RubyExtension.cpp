  ...
  namespace ruby
  {
    namespace taskbarutils
    {
      namespace
      {
        ...
        void wrap_progressbar_free(void *progressbar);
        ...
        const rb_data_type_t kTaskbarProgressDataType = {
            "TaskbarProgress",
            {
                nullptr,
                wrap_progressbar_free,
                nullptr,
            },
            nullptr,
            nullptr,
        ...
        TaskbarProgress *get_progressbar(VALUE self)
        {
          ...
          TypedData_Get_Struct(self, TaskbarProgress, &kTaskbarProgressDataType, progressbar);
          return progressbar;
        }
        ...
        {
          TaskbarProgress *progressbar =
              static_cast<TaskbarProgress *>(ruby_xmalloc(sizeof(TaskbarProgress)));
          memset(progressbar, 0, sizeof(TaskbarProgress));
          return TypedData_Wrap_Struct(klass, &kTaskbarProgressDataType, progressbar);
        }
...
extern "C" void Init_TaskbarProgress()
{
